...
public class ShapeMain{
	public static void main(String args[]){
		...
		System.out.println(total);
                MyShape<Double>[] graph=new MyShape[total];
                int count = 0;
		while(true){
			...
			switch(num){
				case 0: 
                                        if(count>=total)
                                            showMessageDialog(null,"Can't create more object than "+total);
                                        else{
					...
					switch(type){
						...
						case 0:
							...
							graph[count++] = new Circle(nums.get(0),nums.get(1),nums.get(2));							
							break;
						...
						case 1:
							...
							graph[count++] = new Rectangle(nums.get(0),nums.get(1),nums.get(2),nums.get(3));
							break;						
						case 2:
							...
							graph[count++] = new Triangle(nums.get(0),nums.get(1),nums.get(2),nums.get(3),nums.get(4),nums.get(5));
							break;
				...
				case 1://display all graph objects                                
					disp_All_Object(graph);
				        break;
				case 2:
					disp_All_Object_Area(graph);
					break;				
				case 3:                                
					return;
			}//end of main menu
